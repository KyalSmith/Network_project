...
class test_form(QtGui.QMainWindow):
    ...
    def setup_gui(self):
        ...
        self.total_incoming_metric = QtGui.QLabel("KB/s")
        ...
        self.total_outgoing_metric = QtGui.QLabel("KB/s")
    ...
    def find_total(self):
        ...
        self.total_incoming_val.setText(str(round(float(result_list[0])/1000,2)))
